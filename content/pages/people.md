...
<div class="media">
    <a class="pull-left" href="#">
        <img style="max-height: 64px; max-width: 64px" src="../images/people/Andreas-Brotzer.jpg" alt="Andreas Brotzer" class="img-circle media-object">
    </a>
    <div class="media-body">
        <h4 class="media-heading">Andreas Brotzer (LMU)</h4>
<!--      <a href="http://www.geophysik.uni-muenchen.de/Members/donner">Website</a> -->
    </div>
</div>
